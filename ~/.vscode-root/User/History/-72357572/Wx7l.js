...
app.get('/generos', (req, res) => apiWrapper(req, res, async () => {
    try {
        ...
        // 💡 CORRECCIÓN: Accedemos directamente a la propiedad 'genres' que está
        // dentro del objeto 'body' de la respuesta. 
        // Si data.body es undefined, usamos data.genres (aunque es menos común)
        ...
        // En caso de que Spotify devuelva un 404 para esta llamada (que no debería),
        // lanzamos un error más claro.
        console.error('Error específico al cargar géneros:', e);
        throw { statusCode: 500, message: 'Fallo al obtener la lista de géneros disponibles de Spotify.' };
    }
}));
