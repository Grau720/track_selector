...
// index.js - REEMPLAZAR el ENDPOINT /generos EXISTENTE con este bloque
// 🛑 ENDPOINT /generos (Aislamiento Total con la función CORRECTA y DEBUG)
app.get('/generos', async (req, res) => {
    // 1. Instancia aislada para llamadas de credenciales de cliente
    ...
    try {
        ...
        // Si hay un cuerpo de error (p. ej., si el client_secret es inválido, deberíamos verlo aquí)
        if (e.body) {
        ...
        res.status(statusCode).json({ 
            error: `Fallo al obtener géneros (${statusCode}). Por favor, verifica tus credenciales.`,
            detail: e.message 
        });
    }
});
