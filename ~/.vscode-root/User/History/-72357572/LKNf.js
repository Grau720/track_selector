...
// 🛑 OPCIÓN ROBUSTA (Aislamiento Total con la función CORRECTA)
app.get('/generos', async (req, res) => {
    ...
    try {
        ...
        console.error('Error al cargar géneros (FINAL):', e.message);
        res.status(e.statusCode || 500).json({ 
            error: `Fallo al obtener géneros (${e.statusCode}): ${e.message}`
        });
    }
});
